...
import { Github, Linkedin, Mail, ArrowDown, Code, Database, Server, Download } from "lucide-react"
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            >
              {/* Explore Projects Button - ensure visible and styled */}
              <motion.div 
              ...
              >
                <Button
                  ...
                  sx={{
                    background: `linear-gradient(90deg, var(--${currentTheme.accent?.replace('text-', '')} || #3b82f6), var(--${currentTheme.accent?.replace('text-', '')}-light || #06b6d4))`,
                    color: 'white',
                    borderRadius: '999px',
                    padding: { xs: '10px 22px', sm: '14px 36px' },
                    fontWeight: 700,
                    ...
                    '&:hover': {
                      background: `linear-gradient(90deg, var(--${currentTheme.accent?.replace('text-', '')}-dark || #2563eb), var(--${currentTheme.accent?.replace('text-', '')} || #3b82f6))`,
                      boxShadow: `0 8px 24px ${currentTheme.accent?.replace('text-', 'bg-') || 'bg-blue-500'}40`,
                      filter: 'brightness(1.08)',
                    },
                    '&:focus-visible': {
                      boxShadow: `0 0 0 3px #fff, 0 0 0 6px var(--${currentTheme.accent?.replace('text-', '')}80, #3b82f680)`
                    },
                  }}
                ...
                >
                  ...
                  <span className="absolute left-0 top-0 w-full h-full pointer-events-none overflow-hidden rounded-full">
                    <span className="absolute left-[-75%] top-0 w-1/2 h-full bg-white/30 blur-lg group-hover/button:animate-shine" />
                  </span>
                </Button>
              </motion.div>
              ...
              >
                <Button
                  variant="contained"
                  size="large"
                  href="https://drive.google.com/uc?export=download&id=1KuEsOUaRGbiRgMNGraxDYpdHM1uWGMRQ"
                  target="_blank"
                ...
                {/* Enhanced Tooltip */}
                <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-slate-900/90 backdrop-blur-sm text-white px-4 py-2 rounded-lg text-sm opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none whitespace-nowrap transform group-hover:-translate-y-1">
